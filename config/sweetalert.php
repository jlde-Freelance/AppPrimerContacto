...
return [
    ...
    */
    ...
    'customClass' => [
        ...
        'confirmButton' => env('SWEET_ALERT_CONFIRM_BUTTON_CLASS', 'prc-button'),
        'cancelButton' => env('SWEET_ALERT_CANCEL_BUTTON_CLASS','prc-button prc-button-secondary'),
    ...
    */
    ...
    'confirm_delete_confirm_button_text' => env('SWEET_ALERT_CONFIRM_DELETE_CONFIRM_BUTTON_TEXT', '¡Sí, Confirmo!'),
