...
{{--                        </div>--}}
                        <div class="mt-12 text-center">
                            ...
                            <div class="mt-6">
                                <a href="#" class="p-2 bg-transparent hover:bg-blue-green border border-blue-green text-blue-green hover:text-white rounded-md"><i class="bi bi-telephone-inbound align-middle me-2"></i> Contáctenos</a>
                            </div>
                        </div>
                    </div>
                </div>
